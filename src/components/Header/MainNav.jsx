...
const menuItems = [
  ...
  { label: 'Giới thiệu', href: '/gioi-thieu' },
  {
    ...
    href: '/',
    children: [
      { label: 'Gạch Ấn Độ', href: '/?category=Gạch Ấn Độ' },
      { label: 'Gạch Nhập Khẩu', href: '/?category=Gạch Nhập Khẩu' },
      { label: 'Gạch Tây Ban Nha - Italy', href: '/?category=Gạch Tây Ban Nha - Italy' },
      { label: 'Gạch Nội', href: '/?category=Gạch Nội' },
      { label: 'Thiết Bị Vệ Sinh', href: '/?category=Thiết Bị Vệ Sinh' },
    ],
  },
  { label: 'Sản phẩm khuyến mãi', href: '/?tab=Khuyến mãi', highlight: true },
  {
